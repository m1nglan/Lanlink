...
#define RTASR_PORT               (443)        /*!< 443=wss, 80=ws */
#define RTASR_USE_TLS            (1)          /*!< 1=wss(推荐), 0=ws */
...
private:
    ...
    void *m_ws = NULL;              /*!< websocket transport 句柄 */
    TaskHandle_t m_reader = NULL;   /*!< reader 任务 */
